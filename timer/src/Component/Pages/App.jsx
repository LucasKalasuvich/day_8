...
const App = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCountdown((prevCountdown) => {
        ...
        const totalSeconds = prevCountdown.days * 24 * 60 * 60 + prevCountdown.hours * 60 * 60 + prevCountdown.minutes * 60 + prevCountdown.seconds;
  ...
  return (
    <>
      <div>
        {/* <div className="time">
            <h1 className="txt-time" id="timer"></h1>
          </div> */}
        ...
        <div className="wrapper-countdown2">
          ...
          <div className="date-countdown">
            <h5>{Number(countdown.seconds) > 1 ? "SECOND" : "SECOND"}</h5>
          </div>
        </div>
